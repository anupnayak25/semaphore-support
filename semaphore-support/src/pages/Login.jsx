  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        ...
        toast.error('This domain is not authorized. Please contact admin.');
      } else {
  ...
  return (
    <div className="login-container">
      <div className="login-card">
        {/* Logo/Icon */}
        <div className="login-logo p-0.5"><img src="/semaphore_logo.png" alt="S" /></div>

        {/* Title */}
        <h1 className="login-title">Welcome to Semaphore</h1>
        ...
        <button onClick={handleGoogleSignIn} className="google-signin-btn">
          {/* Google Icon */}
          <svg className="google-icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
