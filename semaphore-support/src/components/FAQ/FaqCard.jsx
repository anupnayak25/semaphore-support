...
const FaqCard = ({ question, answer }) => {
  ...
  return (
    <div className="bg-dominant  border border-highlight rounded-lg p-4 mb-4">
      <button
      ...
      >
        ...
        <ChevronRight 
          className={`text-highlight w-5 h-5 flex-shrink-0 transition-transform delay-100 duration-200 ease-out ${
